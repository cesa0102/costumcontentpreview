...
return [
    'packages' => [
        ...
        'costumcontentpreview' => [
            'composerName' => 'costumcontentpreview',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/costumcontentpreview/',
            'suggestions' => [],
        ],
        'scriptmerger' => [
            'composerName' => 'sgalinski/scriptmerger',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/scriptmerger/',
            'suggestions' => [],
        ],
        'seo_fields' => [
            'composerName' => 'seo_fields',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/seo_fields/',
            'suggestions' => [],
        ],
        'sourceopt' => [
